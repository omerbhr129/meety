...
function EditMeetingPage() {
        ...
        const initialDays = DAYS.reduce((acc, day) => {
          ...
          return {
            ...
            [day.id]: {
              ...
              timeSlots: dayAvailability?.timeSlots?.length > 0 
  ...
  const handleSubmit = async () => {
    try {
      ...
      // Create availability object using helper function
            ...
            <div className="relative">
              ...
              <div className="p-8 space-y-12">
                <div className="text-center">
                  <div className="inline-flex p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl mb-6 shadow-inner">
                    {step === 'settings' ? (
                ...
                {step === 'settings' ? (
                  <div className="space-y-10">
                      ...
                      <div className="grid grid-cols-3 gap-4">
                        {MEETING_TYPES.map(({ id, icon: Icon, label, description }) => (
                          <button
                            ...
                            className={`
                              p-8 rounded-xl border-2 transition-all group hover:bg-gray-50 
                              ${settings.type === id 
                    ...
                    <Button
                      ...
                      className="w-full bg-blue-500 hover:bg-blue-600 text-white p-6 text-lg transition-all"
                    >
                      המשך להגדרת זמינות
                    </Button>
                  </div>
                  ...
                  <div className="space-y-6">
                            ...
                            <div className="mt-3 p-6 bg-white rounded-xl border border-gray-200 space-y-4">
                              ...
                              <Button
                                ...
                                className="w-full py-6 border-2 border-dashed border-gray-200 
                                       text-gray-500 hover:border-blue-200 hover:text-blue-600 
                                       hover:bg-blue-50/50 font-medium rounded-xl"
                              >
                    ...
                    <div className="flex gap-4">
                      ...
                      <Button
                        ...
                        className="flex-1 bg-blue-500 hover:bg-blue-600 text-white p-6 text-lg"
                      >
                        שמור שינויים
                      </Button>
                    </div>
